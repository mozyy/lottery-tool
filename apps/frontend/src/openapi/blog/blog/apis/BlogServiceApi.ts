...
export class BlogServiceApi extends runtime.BaseAPI {
    ...
    /**
     */
    async blogServiceListRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BlogblogListResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async blogServiceList(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BlogblogListResponse> {
